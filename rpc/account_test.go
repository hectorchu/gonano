...
func TestAccountHistoryRaw(t *testing.T) {
	...
	assert.Equal(t, "CEC5287A00F5A50E11A80EC3A63C575D37BFD5BAD87BCB1B7E46DBCBE2F1EC3E", h.Link)
	assertEqualBig(t, "134000000000000000000000000", h.Balance)
	assert.Equal(t, "CEC5287A00F5A50E11A80EC3A63C575D37BFD5BAD87BCB1B7E46DBCBE2F1EC3E", h.Previous)
	...
	assert.Equal(t, uint64(3), h.Height)
	assert.Equal(t, "8C1B5D4BBE27F05C7A888D1E691A07C550A81AFEE16D913EE21E1093888B82FD", h.Hash)
	assert.Equal(t, "788f7ec074f1854b", h.Work)
	assert.Equal(t, "E0F2C0187F87917C28BB989DA516114F64FEEAD307011F73F1A0982B3603A51740279ED5DA4D428C3F0E652A638BB75F790B695F9D23125B54DB3312A7F28100", h.Signature)
	assert.Equal(t, "CEC5287A00F5A50E11A80EC3A63C575D37BFD5BAD87BCB1B7E46DBCBE2F1EC3E", previous)
}
