...
const signature = "E0F2C0187F87917C28BB989DA516114F64FEEAD307011F73F1A098" +
	"2B3603A51740279ED5DA4D428C3F0E652A638BB75F790B695F9D23125B54DB3312A7F28100"
...
func TestAccountBalance(t *testing.T) {
	balance, pending, err := getClient().AccountBalance(context.Background(), testAccount)
	require.Nil(t, err)
...
func TestAccountHistory(t *testing.T) {
	history, previous, err := getClient().AccountHistory(context.Background(), testAccount, 1, nil)
	require.Nil(t, err)
...
func TestAccountHistoryRaw(t *testing.T) {
	history, previous, err := getClient().AccountHistoryRaw(context.Background(), testAccount, 1, nil)
	require.Nil(t, err)
	...
	assertEqualBytes(t, signature, h.Signature)
	assertEqualBytes(t, "CEC5287A00F5A50E11A80EC3A63C575D37BFD5BAD87BCB1B7E46DBCBE2F1EC3E", previous)
}

func TestAccountInfo(t *testing.T) {
	i, err := getClient().AccountInfo(context.Background(), testAccount)
	require.Nil(t, err)
...
func TestAccountRepresentative(t *testing.T) {
	representative, err := getClient().AccountRepresentative(context.Background(), testAccount)
	require.Nil(t, err)
...
func TestAccountWeight(t *testing.T) {
	weight, err := getClient().AccountWeight(context.Background(), testAccount)
	require.Nil(t, err)
...
func TestAccountsBalances(t *testing.T) {
	balances, err := getClient().AccountsBalances(context.Background(), []string{testAccount})
...
func TestAccountsFrontiers(t *testing.T) {
	frontiers, err := getClient().AccountsFrontiers(context.Background(), []string{testAccount})
...
func TestAccountsPending(t *testing.T) {
	pendings, err := getClient().AccountsPending(context.Background(), []string{
...
func TestFrontierCount(t *testing.T) {
	count, err := getClient().FrontierCount(context.Background())
...
func TestRepresentatives(t *testing.T) {
	representatives, err := getClient().Representatives(context.Background(), 2)
...
func TestRepresentativesOnline(t *testing.T) {
	representatives, err := getClient().RepresentativesOnline(context.Background())
